...
section.category-name 
    .container 
        h2.text-center.text-capitalize.pt-4.pb-4 {{ page }}
        .content.p-4.d-grid.justify-content-center.align-items-center
          .card.rounded(v-for="post in posts.meals" :key="post.idMeal")
...
export default {
  ...
  mounted() {
    return this.getData(`filter.php?c=${this.$route.params.name}`);
  },
};
</script>
